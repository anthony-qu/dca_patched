...
from tensorflow.keras.optimizers import legacy as opt
...
# --- create ONE global Session and bind it to Keras ---
_cfg = tf.compat.v1.ConfigProto()
# if you pass a 'threads' arg later, we’ll set it on _cfg inside train()
_sess = tf.compat.v1.Session(config=_cfg)
K.clear_session()
